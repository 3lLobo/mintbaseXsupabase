...
import { ToggleMode, ToggleNetwork } from './toggle-mode'
...
export default function Header({mintbaseNetwork, setMintbaseNetwork}) {
    ...
    const { user } = useUser()
    // const [network, setNetwork] = useLocalStorage('mintbaseNetwork', "testnet")
                            ...
                            <Box className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                                ...
                                <Box className="hidden sm:block sm:ml-6">
                                    <Box className="flex space-x-4">
                                        ...
                                        <Box>
                                        <ToggleNetwork setNetwork={setMintbaseNetwork} network={mintbaseNetwork}></ToggleNetwork>
                                        </Box>
                                    </Box>
                                </Box>
                            </Box>
